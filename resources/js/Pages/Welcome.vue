...
<template>
    ...
    <section class="narrow-wrapper my-24 lg:my-52">
        <div>
            ...
            >
                Everyone wants to book time with you, and for good reason! But
                your time is best spent creating the value everyone wants.
                Heygumball puts the power back in your hands by letting you
                decide when you&apos;re open to take requests and by giving you
                tools to manage, sort, and respond in a simple and efficient
                way!
            </BaseText>
        </div>
        ...
        <div class="max-w-3xl mx-auto">
            <div class="grid lg:grid-cols-2 gap-12 items-center my-20 lg:my-48">
                <div class="flex flex-col space-y-3">
                    ...
                    <BaseText>
                        Do you know when you'll be booking next? Get ahead of
                        the curve by scheduling your Heygumball form to be live
                        and open to the public.<br /><br />You'll get
                        notifications when requests start coming in
                        <span class="italic">and</span> your request form will
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center my-20 lg:my-48">
                ...
                <div class="flex flex-col space-y-3">
                    ...
                    <BaseText>
                        Navigating your requests has never been easier! Search
                        by keyword, name, date- you name it, we find it.<br /><br />Requests
                        are grouped by collections by default, making it easy
                        for you to see the most recent and relevant items.
                    </BaseText>
                </div>
            </div>
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center my-20 lg:my-48">
                <div class="flex flex-col space-y-3">
                    ...
                    <BaseText>
                        ...
                        Once you've narrowed down your options, one-click reply
                        to those that made the cut and start filling up your
                        calendar!
                    </BaseText>
                </div>
